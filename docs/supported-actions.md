...
| Authenticated UXP additions | 89 | Advertised only while a compatible authenticated UXP panel is connected |
| Default profile with UXP | 415 | 326 core plus 89 UXP tools |
