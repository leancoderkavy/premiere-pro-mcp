...
| `preview_mogrt_recipe` | Default profile | `recipe`: `lower_third` | Preview a bounded After Effects lower-third MOGRT recipe. It validates one existing workspace output directory but does not contact Adobe or write any files. |
