...
| Authenticated UXP additions | 85 | Advertised only while a compatible authenticated UXP panel is connected |
| Default profile with UXP | 411 | 326 core plus 85 UXP tools |
