...
| `manage_markers_uxp` | Connected UXP | `inspect`, `add`, `update`, `remove`, `remove_many` | Inspect, add, update/move, remove, or explicitly review-then-remove a bounded marker batch by stable GUID using documented, undoable Premiere actions. |
