...
export function normalizeGeneratedManifest(content) {
...
async function main() {
  ...
  if (checkOnly) {
    ...
    // Git may check this generated JSON out with CRLF on Windows. Compare its
    // content, not its checkout-specific line endings, while continuing to
    // generate a canonical LF file for the repository.
    if (normalizeGeneratedManifest(current) !== expected) {
