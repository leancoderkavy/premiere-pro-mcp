...
324 core tools across 37 modules, 4 resources, and 11 guided workflows. A connected UXP host adds 55 capability-gated tools.
...
`inspect,edit,export,filesystem` profile advertises 322 of the 324 registered
...
## Tools (324 core total; 322 under the default profile; 377 with a connected UXP bridge)
...
│   ├── server.ts                # MCP server — registers 324 tools, filtered by authority profile
│   ├── bridge/
