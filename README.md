...
The AI handles the entire workflow through 328 core tools spanning the supported ExtendScript, QE DOM, local media and interchange analysis, revisioned project-context retrieval, safe edit-planning, project-intake preview, review handoff, and connection-verification surfaces. A compatible, authenticated UXP panel adds 88 documented, capability-gated tools without replacing the production CEP bridge.
...
authority, and all 88 authenticated UXP additions with their current action or mode
