...
323 core tools across 37 modules, 4 resources, and 11 guided workflows. A connected UXP host adds 55 capability-gated tools.
...
`inspect,edit,export,filesystem` profile advertises 321 of the 323 registered
...
## Tools (323 core total; 321 under the default profile; 376 with a connected UXP bridge)
...
│   ├── server.ts                # MCP server — registers 323 tools, filtered by authority profile
│   ├── bridge/
