...
359 core tools across 47 modules, 4 resources, and 16 guided workflows. A connected UXP host adds 93 capability-gated tools.
...
`inspect,edit,export,filesystem` profile advertises 357 of the 359 registered
...
## Tools (359 core total; 357 under the default profile; 450 with a connected UXP bridge)
...
│   ├── server.ts                # MCP server — registers 359 tools, filtered by authority profile
│   ├── bridge/
