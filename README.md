...
357 core tools across 46 modules, 4 resources, and 16 guided workflows. A connected UXP host adds 93 capability-gated tools.
...
`inspect,edit,export,filesystem` profile advertises 355 of the 357 registered
...
## Tools (357 core total; 355 under the default profile; 448 with a connected UXP bridge)
...
│   ├── server.ts                # MCP server — registers 357 tools, filtered by authority profile
│   ├── bridge/
