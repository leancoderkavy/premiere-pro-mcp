...
361 core tools across 48 modules, 4 resources, and 16 guided workflows. A connected UXP host adds 93 capability-gated tools.
...
`inspect,edit,export,filesystem` profile advertises 359 of the 361 registered
...
## Tools (361 core total; 359 under the default profile; 452 with a connected UXP bridge)
...
│   ├── server.ts                # MCP server — registers 361 tools, filtered by authority profile
│   ├── bridge/
