...
363 core tools across 49 modules, 4 resources, and 16 guided workflows. A connected UXP host adds 93 capability-gated tools.
...
`inspect,edit,export,filesystem` profile advertises 361 of the 363 registered
...
## Tools (363 core total; 361 under the default profile; 454 with a connected UXP bridge)
...
│   ├── server.ts                # MCP server — registers 363 tools, filtered by authority profile
│   ├── bridge/
