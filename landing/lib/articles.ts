  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          "The server currently registers 308 core structured tools across timeline work, effects and Lumetri color, audio, captions, markers, keyframes, project organization, project-intake preview, media and proxy workflows, diagnostics, export, and local editorial planning. The default capability profile exposes 306 of those tools. An authenticated compatible UXP host can add 50 capability-gated tools, bringing the connected surface to 356.",
  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          "MCP for Adobe Premiere Pro is free, MIT-licensed, and designed for local-first use. It registers 308 core tools for project inspection, project-intake preview, timeline editing, effects, color, audio, media management, diagnostics, export, and review-only editorial planning. The default profile deliberately limits the surface to 306 tools; a compatible authenticated UXP host can add 50 capability-gated tools. These boundaries let the client report what is available rather than pretending that every supported feature is ready at every moment.",
