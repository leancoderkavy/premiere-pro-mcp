  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          "The server currently registers 327 core structured tools across timeline work, effects and Lumetri color, audio, captions, markers, keyframes, project organization, project-intake preview, media and proxy workflows, local media and interchange preflight analysis, diagnostics, export, review handoff, and local editorial planning. The default capability profile exposes 325 of those tools. An authenticated compatible UXP host can add 59 capability-gated tools, bringing the connected surface to 384.",
  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          "MCP for Adobe Premiere Pro is free, MIT-licensed, and designed for local-first use. It registers 327 core tools for project inspection, project-intake preview, timeline editing, effects, color, audio, media management, local media and interchange preflight analysis, diagnostics, export, review handoff, and review-only local editorial planning. The default profile deliberately limits the surface to 325 tools; a compatible authenticated UXP host can add 59 capability-gated tools. These boundaries let the client report what is available rather than pretending that every supported feature is ready at every moment.",
