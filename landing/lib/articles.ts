  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          "The server currently registers 328 core structured tools across timeline work, effects and Lumetri color, audio, captions, markers, keyframes, project organization, project-intake preview, media and proxy workflows, local media and interchange preflight analysis, diagnostics, export, review handoff, and local editorial planning. The default capability profile exposes 326 of those tools. An authenticated compatible UXP host can add 65 capability-gated tools, bringing the connected surface to 391.",
