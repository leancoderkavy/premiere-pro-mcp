      ...
      <main id="main-content" className="min-h-screen bg-black text-zinc-100">
        <section className="border-b border-zinc-900 px-5 pb-16 pt-14 sm:pb-24 sm:pt-20">
          <div className="mx-auto max-w-4xl">
            <nav aria-label="Breadcrumb" className="text-sm text-zinc-500"><HomeLink href="/" className="hover:text-purple-200">MCP for Adobe Premiere Pro</HomeLink> <span aria-hidden="true">/</span> Collaboration workflow</nav>
