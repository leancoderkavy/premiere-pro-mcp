...
export const metadata: Metadata = {
  ...
  description: "Install Premiere Pro MCP, connect Claude, Cursor, or Windsurf, explore 279 AI video editing tools, and understand Windows, macOS, CEP, UXP, and security support.",
...
const categories = [
  ...
  ["Inspection and workflows", "Use 279 tools, three resources, four prompts, edit-plan previews, capability profiles, and audit events."],
]
      ...
      <article className="mx-auto max-w-4xl">
        ...
        <header className="border-b border-zinc-800 pb-12 pt-12">
          ...
          <p className="mt-6 max-w-3xl text-lg leading-8 text-zinc-400">
            Premiere Pro MCP is an open-source, local-first Model Context Protocol server that connects AI assistants to Adobe Premiere Pro through 279 structured editing, inspection, automation, and export tools.
          </p>
        </header>
